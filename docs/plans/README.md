...
Feature plans and build steps. Each doc covers one feature arc from design to commit order.

| File | Status | Description |
|------|--------|-------------|
| [steps-game-loop.md](steps-game-loop.md) | ✅ Implemented | Core game loop — Steps 1–10 |
